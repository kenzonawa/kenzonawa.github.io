...
$(window).scroll(function() {    
    ...
    var block4 = $("#block4").offset().top-100;
    var block5 = $("#block5").offset().top-100;
    var block6 = $("#block6").offset().top-100;
    var block7 = $("#block7").offset().top-100;
    var block8 = $("#block8").offset().top-100;
    var block9 = $("#block9").offset().top-100;
    var block10 = $("#block10").offset().top-100;
    var block11 = $("#block11").offset().top-100;
